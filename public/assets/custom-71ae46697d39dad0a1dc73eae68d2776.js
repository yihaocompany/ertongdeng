...
/* ---------------------------------------------------------------------- */
	...
	$.include('/assets/jquery.cycle.all.min.js');
	$.include('/assets/respond.min.js');
	
	if(jQuery("html").is(".ie8")) {
		$.include('/assets/selectivizr.js')
	}
	
	if(jQuery('#portfolio-items').length) {$.include('/assets/jquery.isotope.min.js');}
	if(jQuery('.single-image').length) {$.include('/assets/jquery.fancybox.pack.js');}
	if(jQuery('#jstwitter').length) {$.include('/assets/twitter.js');}
...
jQuery(document).ready(function($) {
	...
	/* ---------------------------------------------------------------------- */
    if ($('#slider').length) {
        $.include('/assets/jquery.flexslider-min.js');
	...
	(function() {
		...
		if($('#contactform').length) {
			...
			$loader = '<img src="/assets/preloader.gif" alt="Loading..." />';
